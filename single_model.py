...
# only acoustic modality
class MHGNN_wav(nn.Module):
    ...
    def __init__(self, args, num_class):
        ...
        transf_layer=nn.TransformerEncoderLayer(d_model=args.hidden_dim*self.graphs,nhead=4,batch_first=True)
        ...
        self.fusion_fc=nn.Linear(args.hidden_dim*self.graphs,num_class)
...
class MHGNN_text(nn.Module):
    ...
    def forward(self, wav_fea,text_fea, adj):
        ...
        wav_fea = F.relu(self.wav_fc(text_fea))   # 1024-->300
        for i in range(self.args.gnn_layers):
